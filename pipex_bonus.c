...
/*   Updated: 2024/04/09 18:17:48 by asabir           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void manage_pipes(int nb_fd)
{

    int fd[nb_fd][2];
    while(nb_fd)
    {
        //we are gonna make sure if the cmd is there
        //a fucnction that takes the input from the previous file descriptor and sends it to the next
    }
}
